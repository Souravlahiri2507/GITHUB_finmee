    ...
    <div>
      <div className="user-profile">
        <img
          ...
          src="https://avatars.githubusercontent.com/u/112802532?s=40&v=4"
          alt="User Avatar"
        />
        <span className="user-name">Souravlahiri2507</span>
        <div className="caret-icon">▼</div>
      </div>
      <div className="repositories">
        <div className="repositories-header">
          <span>Top Repositories</span>
          <button className="new-repo-button">
            <span>New</span>
          </button>
        </div>
        ...
        <div className="repository-list">
          <div className="repository">
            ...
            />
            <span className="repo-name">ntwist-assignment</span>
          </div>
          <div className="repository">
            <img
              className="repo-avatar"
